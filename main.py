...
def sample_memory_add_state_to_chains_and_agents():
    """
    If you look inside the memory object, you can see the history of messages
    https://python.langchain.com/en/latest/getting_started/getting_started.html#id1
    """
    ...
    # I can answer questions, provide information, and even have
...
if __name__ == "__main__":
    ...
    # sample_memory_add_state_to_chains_and_agents()
